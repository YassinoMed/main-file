    ...
    public function store(Request $request)
    {
        ...
        if($usr->can('create lead'))
        {
            ...
            else
            {
                ...
                Utility::dispatchAutomationEvent('lead.created', $lead, $usr->creatorId());
    ...
    public function bulk(Request $request)
    {
        ...
        if ($action === 'export') {
            ...
            return response()->streamDownload(function () use ($leads) {
                ...
                fputcsv($out, ['ID', 'Name', 'Subject', 'Stage', 'Email', 'Phone', 'Users']);
                foreach ($leads as $lead) {
                    $users = $lead->users ? $lead->users->pluck('name')->implode(', ') : '';
        ...
        if ($action === 'delete') {
            ...
            foreach ($ids as $id) {
                $lead = $leads->get($id);
                if (!$lead) {
                    $failed[] = ['id' => $id, 'message' => __('Lead Not Found.')];
                    continue;
                }
                ...
                try {
                    ...
                    $failed[] = ['id' => $id, 'message' => __('Unable to delete this lead.')];
                }
            }
