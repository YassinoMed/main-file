{{ Form::open(['url' => 'production/boms', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('code', '', ['class' => 'form-control', 'placeholder' => __('Enter Code')]) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('version', __('Version'), ['class' => 'form-label']) }}
            {{ Form::text('version', '1', ['class' => 'form-control', 'placeholder' => __('Enter Version')]) }}
        </div>
        <div class="col-md-12">
