                            ...
                            <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                                ...
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-4 f-w-600  ">
                                        {{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}{{ $plan->price . ' / ' . __(\App\Models\Plan::$arrDuration[strtolower((string) $plan->duration)] ?? $plan->duration) }}</small>
                                        </small>
                                    </h3>
