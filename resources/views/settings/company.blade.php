                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="form-check form-switch d-flex gap-2 flex-column p-0 mt-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input mx-0"
                                                        ...
                                                        {{ !empty($setting['cust_darklayout_auto']) && $setting['cust_darklayout_auto'] == 'on' ? 'checked' : '' }} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
